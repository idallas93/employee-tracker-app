...
function allInformation() {
  ...
  connection.query(
    "SELECT r.title, e.role_id, e.first_name, e.last_name, r.salary, e.manager_id FROM department d JOIN role r ON d.id = r.department_id JOIN employee e ON e.role_id = r.id",
    function (err, res) {
    ...
    .prompt([
      {
        ...
        type: "rawlist",
        choices: [
          "View current departments and ID numbers",
    ...
    .prompt([
      {
        name: "id",
        message:
          "What is the ID number of the department you would like to delete?",
        type: "input",
      },
      {
        name: "confirm",
    ...
    .prompt([
      {
        ...
        type: "rawlist",
        choices: [
          "View current roles, departments and ID numbers",
    ...
    .prompt([
      {
        type: "input",
        message:
          "What is the ID number for the department you would like to assign?",
        name: "deptID",
      },
      {
        type: "input",
  ...
  inquirer
    .prompt([
      ...
      },
      {
        type: "input",
        message:
          "What is the ID number for the employee whose role you are assigning?",
        name: "id",
      },
    ])
    .then(function (answer) {
